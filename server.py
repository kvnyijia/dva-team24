...
@app.route('/content_based_cf', methods=['GET'])
def content_based_cf():
  ...
  return jsonify(a=predicted_rating, b=predicted_book, c=predicted_url)
...
def twitter_wordcnt():
  ...
  print('before return')
  return jsonify(book0=recommended_book[0], book1=recommended_book[1], book2=recommended_book[2], dlist=dic_list)
